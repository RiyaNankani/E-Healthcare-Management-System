...
<!--                    <input type="text" name="patientid" id="id" required><span id="error"></span>-->
...
//            //String s="ONLINE";
//            //ResultSet rs = stmt.executeQuery("select count(DISTINCT p_id) as rowcount from appointment where date like '"+dte+"' and mode like '"+s+"' group by '"+dpt+"' ");
//            
//            //rs.next();
...
//          }
            String s="online";
            ResultSet rs = stmt.executeQuery("select count(DISTINCT p_id) from appointment where date='"+dte+"' and d_id='"+dpt+"' and mode='"+s+"'");
            rs.next();
