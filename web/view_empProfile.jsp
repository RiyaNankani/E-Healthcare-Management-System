    ...
    <body>
        ...
        <div class="box">
            ...
            <form action="view_profileE.jsp" onclick="return validate()">
                <div class="inputbox">
<!--                    <input type="text" name="empid" id="id" required><span id="error"></span>-->
                    <input type="text" name="empid" id="id" value=<%=request.getParameter("id")%> required><span id="error"></span>
