...
<%
    try 
    {
        if (request.getParameter("student")!= null) 
        {
            ...
            String sid="S";
            ResultSet rs=stmt.executeQuery("select * from transaction_info where p_id like ('"+sid+"%')");
            out.print("</br>");
            out.print("</br>");
        ...
        if (request.getParameter("employee")!= null) 
        {
            ...
            Statement stmt = conn.createStatement();
            String eid="E";
            ResultSet rs=stmt.executeQuery("select * from transaction_info where p_id like ('"+eid+"%')");
            out.print("</br>");
            out.print("</br>");
